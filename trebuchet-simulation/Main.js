...
datGUI
  .add(guiControls, "counterMass", 130, 200)
  .name("Counter-weight mass (kg)");
datGUI
  .add(guiControls, "throwingArmLength", 4, 6)
  .name("Throwing arm length (m)");
...
// Textures --------------------------------------------------------------------------------------------
var trebuchetTexture = new THREE.TextureLoader().load(
  "textures/Trebuchet_D.png"
);
