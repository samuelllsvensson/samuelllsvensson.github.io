            ...
            <div className="modal-dialog">                     
              <div className="modal-content">
                ...
                <div className="modal-body">
                  ...
                  My first encounter with React was through the course 'Communication and User Interfaces -<a href="https://liu.se/studieinfo/kurs/tnm040/ht-2019/" target="_blank"> TNM040</a>' course during my second year of university. 
          ...
          <div className="modal fade" id="myModal3" role="dialog">
            <div className="modal-dialog">                     
              <div className="modal-content">
                ...
                <div className="modal-body">
                  <p>For this project, we had free reins over what we wanted to do, as long as it was about audio. This was for the course 'Physics of Sound - <a href="https://liu.se/studieinfo/kurs/tnm040/ht-2019/" target="_blank"> TFYA65</a>'  </p>
                ...
                <div className="modal-footer">
                  <a href="../../files/Ljudfysikrapport.pdf" target="_blank" rel="noopener noreferrer" >Project report</a><br/><br/>
                  <button type="button" className="btn btn-default" data-dismiss="modal">Close</button>
                </div>
              </div>  
            </div>
...
}, 
{
  ...
  render: (
    <div className='portfolio-item'>
      ...
      <div className='portfolio-item__icon'>
        <img src={image4} height="25" width="25"/> 
        <i className="fab fa-js"></i>        
        <img src={image2} height="90" width="90"/> 
      </div>
      <div className='portfolio-item__links'>
            ...
            <div className="modal-dialog">                     
              <div className="modal-content">
                ...
                <div className="modal-body">
                  ...
                  I found an open-source mobile development framework called <a href="https://phonegap.com/" target="_blank">'Adobe Phonegap'</a> which allowed me to use Javascript, HTML5 and CSS3 for cross-platform development. 
                  Phonegap is a distribution of <a href="https://cordova.apache.org/" target="_blank">'Apache Cordova'</a> which comes with a ton of different plugins to utilize device capabilities such as camera, GPS and so on. 
                  ...
                  <img src={image6} height="80%" width="80%"/> 
                  ...
                  <p>Finally I packaged my app into an .apk using <a href="https://build.phonegap.com/" target="_blank">Adobe Phonegap Build</a>. </p>
                  <br/>
                  ...
                  <a href="https://www.youtube.com/watch?v=c3KX1I5SiVI" target="_blank">Here</a> is a short walkthrough of how the app works (translated to english and with example text/images for privacy purposes).</p>
                  <br/><br/>
  ...
  render: (
    <div className='portfolio-item'>
      ...
      <div className='portfolio-item__icon'>
        ...
        <img src={image1} height="60" width="60"/>     
      </div>
      <div className='portfolio-item__links'>
          ...
          <div className="modal fade" id="myModal5" role="dialog">
            <div className="modal-dialog">                     
              <div className="modal-content">
                ...
                <div className="modal-body">
                  <p>For the course '3D-Computer graphics - <a href="https://liu.se/studieinfo/kurs/tnm040/ht-2019/" target="_blank">TNM061</a>' we created 'Amaze' which is a mobile VR game where you start in the center of a maze with the objective of escaping it. 
                ...
                <div className="modal-footer">
                  <a href="../../files/datorgrafikrapport.pdf" target="_blank" rel="noopener noreferrer" >Project report</a><br/><br/>
                  <button type="button" className="btn btn-default" data-dismiss="modal">Close</button>
                </div>
              </div>  
            </div>
          ...
          <div className="modal fade" id="myModal6" role="dialog">
            <div className="modal-dialog">                     
              <div className="modal-content">
                ...
                <div className="modal-body">
                  <p>For the course 'Communication and User Interfaces - <a href="https://liu.se/studieinfo/kurs/tnm040/ht-2019/" target="_blank">TNM040</a>' me and my group decided to develop an Android application. 
                ...
                <div className="modal-footer">
                  <a href="../../files/pandorasrapport.pdf" target="_blank" rel="noopener noreferrer" >Project report</a><br/><br/>
                  <button type="button" className="btn btn-default" data-dismiss="modal">Close</button>
                </div>
              </div>  
            </div>
  ...
  render: (
    <div className='portfolio-item'>
      ...
      <div className='portfolio-item__icon'>
        ...
        <img src={image10} height="60" width="60"/>         
            ...
            <div className="modal-dialog">                     
              <div className="modal-content">
                ...
                <div className="modal-body">
                  ...
                  <a href="https://vimeo.com/194536185" target="_blank">Watch</a> the short film here.
