      ...
      <div className="content-grid">
        ...
        <div className="about-wrapper">
          <div className="about-content" style={{ color: textPrimary }}>
            ...
            <p>
              I’m currently working towards my <a href="https://liu.se/utbildning/program/6cmen" target="_blank">Master of Science (M.Sc.) degree from Linköpings University in Media Technology</a> at campus Norrköping. 
            ...
            <div className="signature">
              <img src={signature} alt="Picture of me" />
            </div>
          </div>
        </div>
      </div>
